...
INSERT INTO s_emp VALUES (
  1, 'Velasquez', 'Carmen', 'cvelasqu',
   '03-5月-90', NULL, NULL, 'President',
   50, 2500, NULL);
   
INSERT INTO s_emp VALUES (
   2, 'Ngao', 'LaDoris', 'lngao',
   '08-5月-90', NULL, 1, 'VP, Operations',
   41, 1450, NULL);
   
INSERT INTO s_emp VALUES (
   3, 'Nagayama', 'Midori', 'mnagayam',
   '17-1月-91', NULL, 1, 'VP, Sales',
   31, 1400, NULL);
   
INSERT INTO s_emp VALUES (
   4, 'Quick-To-See', 'Mark', 'mquickto',
   '07-6月-90', NULL, 1, 'VP, Finance',
   10, 1450, NULL);
   
INSERT INTO s_emp VALUES (
   5, 'Ropeburn', 'Audry', 'aropebur',
   '04-5月-90', NULL, 1, 'VP, Administration',
   50, 1550, NULL);
   
INSERT INTO s_emp VALUES (
   6, 'Urguhart', 'Molly', 'murguhar',
   '18-1月-91', NULL, 2, 'Warehouse Manager',
   41, 1200, NULL);
   
INSERT INTO s_emp VALUES (
   7, 'Menchu', 'Roberta', 'rmenchu',
   '14-5月-90', NULL, 2, 'Warehouse Manager',
   42, 1250, NULL);
   
INSERT INTO s_emp VALUES (
   8, 'Biri', 'Ben', 'bbiri',
   '07-6月-90', NULL, 2, 'Warehouse Manager',
   43, 1100, NULL);
   
INSERT INTO s_emp VALUES (
   9, 'Catchpole', 'Antoinette', 'acatchpo',
   '09-2月-92', NULL, 2, 'Warehouse Manager',
   44, 1300, NULL);
   
INSERT INTO s_emp VALUES (
   10, 'Havel', 'Marta', 'mhavel',
   '27-2月-91', NULL, 2, 'Warehouse Manager',
   45, 1307, NULL);
   
INSERT INTO s_emp VALUES (
   11, 'Magee', 'Colin', 'cmagee',
   '14-4月-90', NULL, 3, 'Sales Representative',
   31, 1400, 10);
   
INSERT INTO s_emp VALUES (
   12, 'Giljum', 'Henry', 'hgiljum',
   '18-1月-92', NULL, 3, 'Sales Representative',
   32, 1490, 12.5);
   
INSERT INTO s_emp VALUES (
   13, 'Sedeghi', 'Yasmin', 'ysedeghi',
   '18-2月-91', NULL, 3, 'Sales Representative',
   33, 1515, 10);
   
INSERT INTO s_emp VALUES (
   14, 'Nguyen', 'Mai', 'mnguyen',
   '22-1月-92', NULL, 3, 'Sales Representative',
   34, 1525, 15);
   
INSERT INTO s_emp VALUES (
   15, 'Dumas', 'Andre', 'adumas',
   '09-10月-91', NULL, 3, 'Sales Representative',
   35, 1450, 17.5);
   
INSERT INTO s_emp VALUES (
   16, 'Maduro', 'Elena', 'emaduro',
   '07-2月-92', NULL, 6, 'Stock Clerk',
   41, 1400, NULL);
   
INSERT INTO s_emp VALUES (
   17, 'Smith', 'George', 'gsmith',
   '08-5月-90', NULL, 6, 'Stock Clerk',
   41, 940, NULL);
   
INSERT INTO s_emp VALUES (
   18, 'Nozaki', 'Akira', 'anozaki',
   '09-2月-91', NULL, 7, 'Stock Clerk',
   42, 1200, NULL);
   
INSERT INTO s_emp VALUES (
   19, 'Patel', 'Vikram', 'vpatel',
   '06-8月-91', NULL, 7, 'Stock Clerk',
   42, 795, NULL);
   
INSERT INTO s_emp VALUES (
   20, 'Newman', 'Chad', 'cnewman',
   '21-1月-91', NULL, 8, 'Stock Clerk',
   43, 750, NULL);
   
INSERT INTO s_emp VALUES (
   21, 'Markarian', 'Alexander', 'amarkari',
   '26-4月-91', NULL, 8, 'Stock Clerk',
   43, 850, NULL);
   
INSERT INTO s_emp VALUES (
   22, 'Chang', 'Eddie', 'echang',
   '30-11月-90', NULL, 9, 'Stock Clerk',
   44, 800, NULL);
   
INSERT INTO s_emp VALUES (
   23, 'Patel', 'Radha', 'rpatel',
   '17-10月-90', NULL, 9, 'Stock Clerk',
   34, 795, NULL);
   
INSERT INTO s_emp VALUES (
   24, 'Dancs', 'Bela', 'bdancs',
   '17-5月-91', NULL, 10, 'Stock Clerk',
   45, 860, NULL);
   
INSERT INTO s_emp VALUES (
   25, 'Schwartz', 'Sylvie', 'sschwart',
   '09-4月-91', NULL, 10, 'Stock Clerk',
   45, 1100, NULL);
...
INSERT INTO s_inventory VALUES (
   40422, 101, 0, 350, 600, 'Phenomenal sales...', '08-2月-93');
INSERT INTO s_inventory VALUES (
...
INSERT INTO s_inventory VALUES (
   50532, 101, 0, 100, 175, 'Wait for Spring.', '12-4月-93');
INSERT INTO s_inventory VALUES (
...
INSERT INTO s_ord VALUES (
   100, 204, '31-8月-92', '10-9月-92',
   11, 601100, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   101, 205, '31-8月-92', '15-9月-92',
   14, 8056.6, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   102, 206, '01-9月-92', '08-9月-92',
   15, 8335, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   103, 208, '02-9月-92', '22-9月-92',
   15, 377, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   104, 208, '03-9月-92', '23-9月-92',
   15, 32430, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   105, 209, '04-9月-92', '18-9月-92',
   11, 2722.24, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   106, 210, '07-9月-92', '15-9月-92',
   12, 15634, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   107, 211, '07-9月-92', '21-9月-92',
   15, 142171, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   108, 212, '07-9月-92', '10-9月-92',
   13, 149570, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   109, 213, '08-9月-92', '28-9月-92',
   11, 1020935, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   110, 214, '09-9月-92', '21-9月-92',
   11, 1539.13, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   111, 204, '09-9月-92', '21-9月-92',
   11, 2770, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   97, 201, '28-8月-92', '17-9月-92',
   12, 84000, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   98, 202, '31-8月-92', '10-9月-92',
   14, 595, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   99, 203, '31-8月-92', '18-9月-92',
   14, 7707, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   112, 210, '31-8月-92', '10-9月-92',
   12, 550, 'CREDIT', 'Y');
COMMIT;

